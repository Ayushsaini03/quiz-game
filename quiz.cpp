...
void question8() {
	...
	else if (answer == "D" || answer == "d") 
    {
		...
		cout << endl;
		cout << "When did Netaji subhash university established?." << endl;
		cout << "[1] 2014" << endl;
		cout << "[2] 1968" << endl;
		cout << "[3] 2015" << endl;
		string answer;
...
void scores_table()
{
	...
	cout << "*********************************************************************" << endl;
	cout << "***** 1 Ayush Saini ***" << "              ***  " << "100" <<"  *****"<< endl;
	cout << "***** 2 Safal        ***" << "              ***  " << "80" << "   *****" << endl;
	...
	if (play_again == "Yes" || play_again == "yes")
	{
		...
		cout << "OK, Thanks for playing Goodbye!!! ";
}